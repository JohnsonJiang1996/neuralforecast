...
from statsforecast.utils import AirPassengersDF, Reversed_AirPassengersDF
...
Y_train2_df = Y_df[(Y_df.ds >= '1950-01-01') & (Y_df.ds <= '1959-12-31')]  # Train from 1951-01-01 to 1959-12-31
Y_train3_df = Y_df[(Y_df.ds >= '1952-01-01') & (Y_df.ds <= '1959-12-31')]  # Train from 1951-01-01 to 1959-12-31
...
def train_and_plot(Y_train_df, title):
    ...
    # for column in Y_hat_df.columns:
    #     Y_hat_df[column].to_csv(f'{column}.txt', index=False)
...
train_and_plot(Y_train3_df, 'AirPassengers Forecast with Modified Training Data')